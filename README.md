...
scalable applications with clean code and stunning UI/UX. 
...
## Experience:
- **3.5+ years** of professional web development
- Built **production-grade** applications with React, Next.js & Node.js
- Animation specialist using **GSAP** & **Framer Motion**
- Design system development with **Storybook**
- RESTful API design & integration
- Headless CMS implementation with **Contentful**
